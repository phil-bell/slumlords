...
class DjangoForm extends LitElement {
  ...
  clearErrors() {
    const errors = document.querySelectorAll('.django-form__field-error, [part="django-form__fallback-error"]');
  ...
  async renderErrors(errors) {
    Object.entries(errors).map(([field, error]) => {
      ...
      this.shadowRoot.querySelector('[part="django-form__fallback-error"]').appendChild(this.errorMessage(error));
    });
  }
